...
@section('content')
    ...
    <form method="POST" action="{{ route('exam.store') }}" id="createExamForm">
        @csrf
        ...
        <div class="form-group">
            ...
            <input type="number" id="tong_so_cau" name="tong_so_cau" value="{{ old('tong_so_cau', 10) }}" min="1" required>
        </div>

        <div class="form-group">
            <label for="thoi_gian">Thời gian làm bài (phút)</label>
            <input type="number" id="thoi_gian" name="thoi_gian" value="{{ old('thoi_gian', 30) }}" min="1" required>
        </div>

        <div class="form-group">
            <label>Chọn câu hỏi</label>
            <div id="questionSelectionContainer">
                <div class="loading-indicator">Vui lòng chọn môn học để hiển thị câu hỏi...</div>
        ...
        <div class="form-actions">
            <button type="submit" class="btn-primary">Tạo bài thi</button>
            <a href="{{ route('exam.list') }}" class="btn-secondary">Hủy</a>
        </div>
    </form>
@endsection
        ...
        function renderQuestions(questions, chuongs) {
            ...
            questions.forEach(question => {
                ...
                <div class="question-item">
                    <input type="checkbox" name="cau_hoi[]" value="${question.ma_cau_hoi}" class="question-checkbox">
